 ...
 * BlogPost Model
 *
 * Represents blog articles in the CMS (Custom Page Type)
 * that exist at /blog/{slug} URLs.
 *
 * Features:
 * - SEO field mirroring for Open Graph and Twitter Cards
 * - Auto-generated unique slugs from blog post name
 * - JSONB content blocks for flexible page layouts
 * - Polymorphic relationships to content resources
 * - Soft delete support
 * - OG type defaults to 'article' for blog content
 *
 * @property int $id
