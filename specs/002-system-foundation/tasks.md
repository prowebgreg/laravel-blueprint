...
- [X] T047 [US4] Create app/Jobs/TestJob.php as a simple test job for verification → @laravel-specialist
...
- [X] T052 [US4] Verify failed job appears in Horizon and can be retried → @laravel-specialist
