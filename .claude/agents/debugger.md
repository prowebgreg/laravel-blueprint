...
Use the `webapp-testing` skill when debugging browser-based issues. Invoke when you need to:

- Capture browser console logs for error diagnosis
- Take screenshots at specific points in a flow
- Reproduce UI bugs systematically with automation
- Inspect rendered DOM state for debugging
- Test fixes in an isolated browser environment

To use: `Skill: webapp-testing`

The skill provides Playwright automation with console logging and screenshot capabilities.
