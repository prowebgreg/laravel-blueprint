...
Use the `webapp-testing` skill for browser-based E2E testing with Playwright. Invoke this skill when you need to:

- Verify UI functionality in a real browser environment
- Capture screenshots for visual verification
- Test user flows and interactions end-to-end
- Debug frontend behavior with console logs
- Validate responsive design and cross-browser compatibility

To use: `Skill: webapp-testing`

The skill provides Playwright scripts and server management helpers for automated browser testing.

### html5-expert

Use the `html5-expert` skill for understanding HTML structure when planning test coverage. Invoke when:

- Defining test cases for form validation and accessibility
- Creating acceptance criteria for semantic HTML compliance
- Planning accessibility test scenarios (landmark navigation, heading structure)
- Reviewing HTML output against quality standards
- Validating SEO requirements in test specifications

To use: `Skill: html5-expert`

The skill provides semantic HTML knowledge for comprehensive quality assurance of web interfaces.
