...
Use the `webapp-testing` skill for frontend performance measurement. Invoke when you need to:

- Measure real browser rendering performance
- Capture Core Web Vitals (LCP, FID, CLS) metrics
- Profile page load behavior with network analysis
- Test performance under simulated conditions
- Validate frontend optimizations in a real browser
